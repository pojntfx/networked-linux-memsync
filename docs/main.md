...
While the average first chunk latency for the memory, file, directory, Redis, S3 and ScylllaDB backends at 0 ms are all similar and all below 3.5 µs, Redis has lowest measured latency at just 2.5 µs.
